...
/**
 * argstostr - Concatenates all the arguments of the program into a single string.
 * @ac: The number of arguments.
 * @av: An array of argument strings.
 *
 * Return: If ac is 0 or av is NULL, or if memory allocation fails, returns NULL.
